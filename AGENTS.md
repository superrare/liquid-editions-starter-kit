...
- Before building a render contract, the easiest Sepolia path is to create the Liquid Edition at `dev.superrare.co/create/liquid-edition`.
...
- For most users, the easiest Sepolia flow is: create the Liquid Edition first at `dev.superrare.co/create/liquid-edition`, then use this repo to build the render contract.
...
- `dev.superrare.co/liquid-editions/11155111/<liquidEditionContractAddress>`
...
- `dev.superrare.co/create/liquid-edition` as the easiest way to get a Sepolia Liquid Edition before building a renderer here
